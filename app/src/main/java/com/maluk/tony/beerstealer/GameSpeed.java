...
public class GameSpeed {
    ...
    public void gameSpeed(int a, Animation animationLU, Animation animLL, Animation animationLD, Animation animLLD,
                          Animation animationRU, Animation animLR, Animation animationRD, Animation animLRD){
